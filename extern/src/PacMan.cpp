...
//void PacMan::OldEater(clustr PACMAN, int element, int oldelement) //it works under the assumption that the clustr paired vector is sorted beforehand!
//{
	...
	//{
		...
		//{ 
			//cout << "Up" << endl;
			//PacMan::OldEater(PACMAN, element+1, element); //start moving up
		//}
	//}
	...
	//{
		...
		//{
			...
			//{
				//cout << "Down" << endl;
				//PacMan::OldEater(PACMAN, element-1, element); // keep moving down
			//}
		//}
		//if (oldelement + 1 == element) // if we came here by moving down
		//{
			...
			//{
				////cout << "F" << endl;
				//cout << "Up" << endl;
				//PacMan::OldEater(PACMAN, element+1, element); // keep moving up
			//}
		//}
		//else if (oldelement == 9999)  // starting point for program
		//{
			...
			////cout << "X" << endl;
			//cout << "Start" << endl;
			//PacMan::OldEater(PACMAN, element-1, element); // move down
			//PacMan::OldEater(PACMAN, element+1, element); // move up
			////return PACMAN;
		//}
	//}
	...
	//{
		...
		//{ 
			//cout << "Down" << endl;
			//PacMan::OldEater(PACMAN, element-1, element); //start moving down
		//}
	//}
