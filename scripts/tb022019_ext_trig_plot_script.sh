...
do
	...
	python2.7 python/plot_producer.py $i"_"$substring$extension -n hit_position_single+double_strip_r_k17 -b 0 -d 'hist e same' --refuse 28 30 --legend ${legends[count]} -o k17_vertical_scan_single+double_hit_position_${legends[count]}.png 
	python2.7 python/plot_producer.py $i"_"$substring$extension -n hit_position_single+double_strip_r_k19 -b 0 -d 'hist e same' --refuse 28 30 --legend ${legends[count]} -o k19_vertical_scan_single+double_hit_position_${legends[count]}.png 
	python2.7 python/plot_producer.py $i"_"$substring$extension -n cluster_position k17 -b0 -d 'h e same' --refuse 28 30 --legend ${legends[count]} -o k17_vertical_scan_cluster_position_${legends[count]}.png 
	python2.7 python/plot_producer.py $i"_"$substring$extension -n cluster_position k19 -b0 -d 'h e same' --refuse 28 30 --legend ${legends[count]} -o k19_vertical_scan_cluster_position_${legends[count]}.png  
	((count++))
done


python2.7 python/plot_producer.py $same -n hit_position_single+double_strip_r_k17 -b 0 -d 'hist e same' --refuse 28 30 --legend 702.7 707.7 712.7 717.7 722.7 752.7 747.7 742.7 737.7 732.7 727.7 -o k17_vertical_scan_single+double_hit_position.png
python2.7 python/plot_producer.py $same -n hit_position_single+double_strip_r_k19 -b 0 -d 'hist e same' --refuse 28 30 --legend 702.7 707.7 712.7 717.7 722.7 752.7 747.7 742.7 737.7 732.7 727.7 -o k19_vertical_scan_single+double_hit_position.png
python2.7 python/plot_producer.py $same -n cluster_position k17 -b0  -d 'hist e same' --refuse 28 30 --legend 702.7 707.7 712.7 717.7 722.7 752.7 747.7 742.7 737.7 732.7 727.7 -o k17_vertical_scan_cluster_position.png
python2.7 python/plot_producer.py $same -n cluster_position k19 -b0  -d 'hist e same' --refuse 28 30 --legend 702.7 707.7 712.7 717.7 722.7 752.7 747.7 742.7 737.7 732.7 727.7 -o k19_vertical_scan_cluster_position.png
