...
do
	...
	python2.7 python/plot_producer.py $i"_"$pedestal0215$extension -n offset -b 0 -d 'hist e' --refuse 28 30
	python2.7 python/plot_producer.py $i"_"$substring$extension -n offset -b 0 -d 'hist e' --refuse 28 30
	
	python2.7 python/plot_producer.py $i"_"$pedestal0215$extension -n cluster_position -d 'h e' --refuse 28 30
	python2.7 python/plot_producer.py $i"_"$pedestal0215$extension -n cluster offset -d 'h e'
...
do
	...
	python2.7 python/plot_producer.py $i"_"$pedestal0213$extension -n offset -b 0 -d 'hist e' --refuse 28 30
	python2.7 python/plot_producer.py $i"_"$substring$extension -n offset -b 0 -d 'hist e' --refuse 28 30
	
	python2.7 python/plot_producer.py $i"_"$pedestal0213$extension -n cluster_position -d 'h e' --refuse 28 30
	python2.7 python/plot_producer.py $i"_"$pedestal0213$extension -n cluster offset -d 'h e'
